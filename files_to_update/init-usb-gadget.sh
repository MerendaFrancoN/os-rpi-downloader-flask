...
echo "/mass_storage/data.bin" > "${USB_MASS_STORAGE_FUNCTIONS_DIR}/lun.0/file"
#echo 1 > "${USB_MASS_STORAGE_FUNCTIONS_DIR}/stall"
#echo 0 > "${USB_MASS_STORAGE_FUNCTIONS_DIR}/lun.0/cdrom"
#echo 0 > "${USB_MASS_STORAGE_FUNCTIONS_DIR}/lun.0/ro"
#echo 0 > "${USB_MASS_STORAGE_FUNCTIONS_DIR}/lun.0/nofua"
#echo 1 > "${USB_MASS_STORAGE_FUNCTIONS_DIR}/lun.0/removable"
#echo "ScanDisk" > "${USB_MASS_STORAGE_FUNCTIONS_DIR}/lun.0/inquiry_string"
